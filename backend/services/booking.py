...
class BookingService:
    ...
    async def create_booking(self, user_id: UUID4, booking: models.BookingCreate) -> models.BookingGet:
        """Создать бронь"""
        ...
        db_booking = await self._db_facade.create_booking(booking=booking)
    ...
    async def change_booking(self, user_id: UUID4, booking_id: UUID4, booking: models.BookingUpdate) -> models.BookingGet:
        ...
        db_booking = await self._db_facade.change_booking(guid=service_id, booking=booking)
        await self._db_facade.commit()
